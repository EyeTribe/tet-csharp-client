namespace TETCSharpClient
{
    internal class Protocol
    {
        ...
        public const string CATEGORY_HEARTBEAT = "heartbeat";

        public const string TRACKER_REQUEST_SET = "set";
        public const string TRACKER_REQUEST_GET = "get";
        public const string TRACKER_MODE_PUSH = "push";
        public const string TRACKER_HEARTBEATINTERVAL = "heartbeatinterval";
